...
HD_PWD='/home/ayman/ml-rvfpga-soc/Courses/RVfpgaSoC/Labs/LabProjects/Lab1/Lab1.runs/BD_bidirec_10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_bidirec_10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_bidirec_10_0.tcl
