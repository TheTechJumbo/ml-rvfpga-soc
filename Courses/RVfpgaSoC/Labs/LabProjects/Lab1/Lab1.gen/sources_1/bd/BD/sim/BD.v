...
module BD
  ...
  output bidir_8;
  output bidir_9;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_0, ASSOCIATED_RESET rst_0, CLK_DOMAIN BD_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_0;
  ...
  BD_bidirec_3_0 bidirec_7
       (.bidir(bidir_7),
        ...
        .outp(bidirec_7_outp));
  BD_bidirec_6_1 bidirec_8
       (.bidir(bidir_8),
        .inp(gpio_wrapper_0_inp_8),
        .oe(gpio_wrapper_0_oe_8),
        .outp(bidirec_8_outp));
  BD_bidirec_7_1 bidirec_9
       (.bidir(bidir_9),
