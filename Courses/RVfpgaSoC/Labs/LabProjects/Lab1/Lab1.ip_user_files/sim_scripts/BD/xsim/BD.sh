...
#
# Script generated by Vivado on Mon Mar 31 13:46:09 BST 2025
...
# script info
echo -e "BD.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BD xil_defaultlib.BD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BD -key {Behavioral:sim_1:Functional:BD} -tclbatch cmd.tcl -protoinst "protoinst_files/BD.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BD.wdb xsim.dir libdpi.so)
