...
#ifndef VERILATED_VVEERWOLF_CORE_TB_AXI_DEMUX__PI2_H_
#define VERILATED_VVEERWOLF_CORE_TB_AXI_DEMUX__PI2_H_  // guard

#include "verilated.h"
class Vveerwolf_core_tb_axi_demux_id_counters__pi5;


class Vveerwolf_core_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vveerwolf_core_tb_axi_demux__pi2 final : public VerilatedModule {
  public:
    // CELLS
    Vveerwolf_core_tb_axi_demux_id_counters__pi5* __PVT__gen_demux__DOT__i_aw_id_counter;
    Vveerwolf_core_tb_axi_demux_id_counters__pi5* __PVT__gen_demux__DOT__i_ar_id_counter;
    ...
    struct {
        ...
        CData/*1:0*/ __PVT__gen_demux__DOT__w_select;
        ...
        CData/*0:0*/ __Vcellinp__gen_demux__DOT__i_aw_id_counter__pop_i;
        IData/*20:0*/ __Vcellinp__gen_demux__DOT__i_b_mux__data_i;
        CData/*0:0*/ __Vcellout__gen_demux__DOT__i_ar_spill_reg__ready_o;
        CData/*0:0*/ __Vlvbound_h4dca579d__1;
        ...
        CData/*1:0*/ gen_demux__DOT__i_w_fifo__DOT____Vlvbound_haf2ca18c__0;
    ...
    struct {
        ...
        VlWide<3>/*73:0*/ __PVT__gen_demux__DOT__slv_aw_chan_select;
        VlWide<3>/*67:0*/ __PVT__gen_demux__DOT__slv_ar_chan_select;
        VlWide<7>/*215:0*/ __Vcellinp__gen_demux__DOT__i_r_mux__data_i;
    ...
    // CONSTRUCTORS
    Vveerwolf_core_tb_axi_demux__pi2(Vveerwolf_core_tb__Syms* symsp, const char* v__name);
    ~Vveerwolf_core_tb_axi_demux__pi2();
    VL_UNCOPYABLE(Vveerwolf_core_tb_axi_demux__pi2);
