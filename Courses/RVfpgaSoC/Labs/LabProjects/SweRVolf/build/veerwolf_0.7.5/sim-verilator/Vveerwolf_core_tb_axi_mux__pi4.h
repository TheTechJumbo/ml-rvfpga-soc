...
#ifndef VERILATED_VVEERWOLF_CORE_TB_AXI_MUX__PI4_H_
#define VERILATED_VVEERWOLF_CORE_TB_AXI_MUX__PI4_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vveerwolf_core_tb_axi_mux__pi4 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __Vlvbound_ha7f417f7__0;
        ...
        CData/*1:0*/ gen_mux__DOT__i_w_fifo__DOT____Vlvbound_h916100ef__0;
    ...
    // CONSTRUCTORS
    Vveerwolf_core_tb_axi_mux__pi4(Vveerwolf_core_tb__Syms* symsp, const char* v__name);
    ~Vveerwolf_core_tb_axi_mux__pi4();
    VL_UNCOPYABLE(Vveerwolf_core_tb_axi_mux__pi4);
