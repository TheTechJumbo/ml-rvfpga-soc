...
VL_ATTR_COLD void Vveerwolf_core_tb_axi_demux__pi2___ctor_var_reset(Vveerwolf_core_tb_axi_demux__pi2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vveerwolf_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vveerwolf_core_tb_axi_demux__pi2___ctor_var_reset\n"); );
    ...
    VL_RAND_RESET_W(74, vlSelf->__PVT__gen_demux__DOT__slv_aw_chan_select);
    ...
    vlSelf->__PVT__gen_demux__DOT__w_select = VL_RAND_RESET_I(2);
    ...
    VL_RAND_RESET_W(68, vlSelf->__PVT__gen_demux__DOT__slv_ar_chan_select);
    ...
    vlSelf->__Vcellinp__gen_demux__DOT__i_aw_id_counter__pop_i = VL_RAND_RESET_I(1);
    vlSelf->__Vcellinp__gen_demux__DOT__i_b_mux__data_i = VL_RAND_RESET_I(21);
    vlSelf->__Vcellout__gen_demux__DOT__i_ar_spill_reg__ready_o = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(216, vlSelf->__Vcellinp__gen_demux__DOT__i_r_mux__data_i);
    vlSelf->__Vlvbound_h4dca579d__1 = VL_RAND_RESET_I(1);
    ...
    vlSelf->gen_demux__DOT__i_w_fifo__DOT____Vlvbound_haf2ca18c__0 = VL_RAND_RESET_I(2);
