...
VL_ATTR_COLD void Vveerwolf_core_tb_axi_mux__pi4___ctor_var_reset(Vveerwolf_core_tb_axi_mux__pi4* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vveerwolf_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vveerwolf_core_tb_axi_mux__pi4___ctor_var_reset\n"); );
    ...
    vlSelf->__Vlvbound_ha7f417f7__0 = VL_RAND_RESET_I(1);
    ...
    vlSelf->gen_mux__DOT__i_w_fifo__DOT____Vlvbound_h916100ef__0 = VL_RAND_RESET_I(2);
