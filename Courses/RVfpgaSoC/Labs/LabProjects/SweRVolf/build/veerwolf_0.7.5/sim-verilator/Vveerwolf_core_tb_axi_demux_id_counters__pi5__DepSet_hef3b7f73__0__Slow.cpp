...
VL_ATTR_COLD void Vveerwolf_core_tb_axi_demux_id_counters__pi5___ctor_var_reset(Vveerwolf_core_tb_axi_demux_id_counters__pi5* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vveerwolf_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vveerwolf_core_tb_axi_demux_id_counters__pi5___ctor_var_reset\n"); );
