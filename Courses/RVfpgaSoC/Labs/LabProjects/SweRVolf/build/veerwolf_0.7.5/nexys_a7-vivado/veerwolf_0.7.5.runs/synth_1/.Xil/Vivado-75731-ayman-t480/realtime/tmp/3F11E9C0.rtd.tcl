...
set genomeRtd $env(RT_TMP)/3F11E9C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {litedram_core__GC0}]"
...
set genomeName [subst -nocommands -novariables {litedram_core__GC0}]
