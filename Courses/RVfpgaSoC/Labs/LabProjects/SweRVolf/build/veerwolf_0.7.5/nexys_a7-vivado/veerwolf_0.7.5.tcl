...
create_project veerwolf_0.7.5 -force
...
set_property verilog_define {VERSION_MAJOR=0 VERSION_MINOR=7 VERSION_PATCH=5 VERSION_REV=13 VERSION_DIRTY=0 VERSION_SHA=9a919805 } [get_filesets sources_1]
...
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/include/veer_types.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lib/beh_lib.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/mem.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/pic_ctrl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dma_ctrl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_aln_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_compress_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_ifc_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_bp_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_ic_mem.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_mem_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu_iccm_mem.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/ifu/ifu.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dec/dec_decode_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dec/dec_gpr_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dec/dec_ib_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dec/dec_tlu_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dec/dec_trigger.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dec/dec.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/exu/exu_alu_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/exu/exu_mul_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/exu/exu_div_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/exu/exu.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_bus_buffer.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_clkdomain.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_addrcheck.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_lsc_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_stbuf.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_bus_intf.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_ecc.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_dccm_mem.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_dccm_ctl.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lsu/lsu_trigger.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dbg/dbg.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dmi/dmi_wrapper.v}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dmi/dmi_jtag_to_core_sync.v}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/dmi/rvjtag_tap.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lib/mem_lib.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lib/ahb_to_axi4.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/lib/axi4_to_ahb.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/veer.sv}
read_verilog -sv {src/chipsalliance.org_cores_VeeR_EH1_1.9/design/veer_wrapper.sv}
source {src/chipsalliance.org_cores_VeeR_EH1_1.9/tools/vivado.tcl}
...
read_verilog {src/serv_1.1.0/rtl/serv_bufreg.v}
read_verilog {src/serv_1.1.0/rtl/serv_alu.v}
read_verilog {src/serv_1.1.0/rtl/serv_csr.v}
read_verilog {src/serv_1.1.0/rtl/serv_ctrl.v}
read_verilog {src/serv_1.1.0/rtl/serv_decode.v}
read_verilog {src/serv_1.1.0/rtl/serv_immdec.v}
read_verilog {src/serv_1.1.0/rtl/serv_mem_if.v}
read_verilog {src/serv_1.1.0/rtl/serv_rf_if.v}
read_verilog {src/serv_1.1.0/rtl/serv_rf_ram_if.v}
read_verilog {src/serv_1.1.0/rtl/serv_rf_ram.v}
read_verilog {src/serv_1.1.0/rtl/serv_state.v}
read_verilog {src/serv_1.1.0/rtl/serv_top.v}
read_verilog {src/serv_1.1.0/rtl/serv_rf_top.v}
...
read_verilog {src/veerwolf_litedram_0/litedram_top.v}
read_verilog {src/veerwolf_litedram_0/litedram_core.v}
read_xdc {src/veerwolf_litedram_0/litedram.xdc}
read_verilog {src/wb_intercon_1.4.1/rtl/verilog/wb_cdc.v}
...
read_verilog -sv {src/veerwolf_0.7.5/rtl/veerwolf_syscon.v}
read_verilog -sv {src/veerwolf_0.7.5/rtl/veerwolf_core.v}
source {src/veerwolf_0.7.5/data/vivado_waiver.tcl}
read_xdc {src/veerwolf_0.7.5/data/veerwolf_nexys.xdc}
...
set_property include_dirs [list config src/chipsalliance.org_cores_VeeR_EH1_1.9/design/include src/pulp-platform.org__common_cells_1.20.0/include src/uart16550_1.5.5-r1/rtl/verilog src/wb_common_1.0.3 src/pulp-platform.org__axi_0.25.0/include src/veerwolf-intercon_0.7.5 src/veerwolf-wb_intercon_0.7.5 .] [get_filesets sources_1]
set_property top veerwolf_nexys_a7 [current_fileset]
